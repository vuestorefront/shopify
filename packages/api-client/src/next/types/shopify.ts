...
export type MetafieldParentResource = Article | Blog | Collection | Customer | Order | Page | Product | NextProductVariant | Shop;
...
export type Product = HasMetafields & Node & OnlineStorePublishable & {
   ...
   */
  variantBySelectedOptions?: Maybe<NextProductVariant>;
...
// TODO MERGED WITH EXISTING
/** A product variant represents a different version of a product, such as differing sizes or differing colors. */
export type NextProductVariant = HasMetafields & Node & {
...
export type CheckoutLineItem = Node & {
  ...
  variant?: Maybe<NextProductVariant>;
};
...
export type Merchandise = NextProductVariant;
