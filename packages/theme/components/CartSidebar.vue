    ...
    >
      <template #title>
        <div class="heading__wrapper">
          ...
          <button
            data-cy="cart-sidebar-button_toggle-cart"
            class="heading__close-button"
            aria-label="Cart sidebar close button"
      ...
      <transition name="fade" mode="out-in">
        <div v-if="totalItems" class="my-cart" key="my-cart">
          <div class="my-cart__total-items">
          ...
          <div class="sidebar-bottom">
            ...
            <a :href="checkoutUrl">
              <SfButton
                data-cy="cart-sidebar-btn_checkout"
                @click="toggleCartSidebar"
        ...
        <div v-else class="empty-cart" key="empty-cart">
          ...
          <SfButton
            data-cy="cart-sidebar-btn_start-shopping"
            class="sf-button--full-width color-secondary"
